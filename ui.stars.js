...
$.widget("ui.stars",
{
  _init: function() {
    ...
    // Map all inputs from $rboxs array to Stars
    this.$stars = this.$rboxs.map(function(i)
    {
      ...
      if((o.isSelect && this.defaultSelected) || this.defaultChecked) {
        o.checked = i;
        o.value = o.defaultValue = o.id2val[i];
    ...
    this.$stars.bind("click.stars", function() {
      ...
      !o.forceSelect && self.callback("star");
    })
